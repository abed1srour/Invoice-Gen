            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input 
                    className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 bg-white text-gray-900 shadow-sm" 
                    value={meta.date} 
                  ...
                  <button
                    ...
                    className="px-4 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg shadow-md hover:from-green-700 hover:to-green-800 transition-all duration-200 font-medium text-sm whitespace-nowrap"
                  >
                    Today
                  </button>
                </div>
                  ...
                  <div className="grid grid-cols-12 gap-4 mb-3">
                    ...
                    <div className="col-span-12 md:col-span-1 flex items-end">
                      <button 
                        ...
                        className="w-full bg-red-500 hover:bg-red-600 text-white px-3 py-2 rounded-lg transition-all duration-200 flex items-center justify-center"
                        title="Remove item"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
